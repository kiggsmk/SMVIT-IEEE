...
import sucicon from './regsuccess.png'
        ...
        <div className={styles.membody}>
            ...
            <div className={styles.memtopcont}>
                ...
                <div className={styles.regcont}>
                    <div className={styles.regsuciconcont}>
                        <img src={sucicon} alt='Success!'/>
                    </div>
                    <div className={styles.regsuctextcont}>
                        <h2 className={styles.regsuctext}>You are Successfully Registered!</h2>
                    </div>
                </div>
            </div>
